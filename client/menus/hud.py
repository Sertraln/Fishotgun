...
class Hud(menu.Menu):
    def __init__(self):
        ...
        self.fishodex = Entity(model="quad", texture="assets/textures/fishodex.png", parent=self, position=(-0.75, 0,3), scale=(0.2,0.3), z=0)
        self.fishodex_text = Text(parent=self.fishodex, text="F", position=(-0.1, -0.2,2.8), scale=(14,10), color=color.white, font=data.fisho_font, z=-1)
