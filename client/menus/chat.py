...
class Chat(menu.Menu):
    def __init__(self):
        ...
        self.message_background = Entity(model='quad',scale=(0.8,0.6),color=color.black66,position=(-0.5,0,0),parent=self)
        self.message_display = Text(text="",position=(-0.85,-0.25,0), parent=self,font=data.fisho_font)
